...
def test(file, iterations, references, tolerances):
    ...
    print(("X-axis force: {} (expected {}+-{})".format(force_x, references[0], tolerances[0])))
    print(("Y-axis force: {} (expected {}+-{})".format(force_y, references[1], tolerances[1])))
    print(("Z-axis force: {} (expected {}+-{})".format(force_z, references[2], tolerances[2])))
    print(("Induced drag: {} (expected {}+-{})".format(induced_drag, references[3], tolerances[3])))
